...
const url= urlConfig.BODY_PART_URL; // modify

const BodyPartTable: React.FC = () =>{ // modify
    ...
    <PageContainer>
      <Card>
        ...
        <Form form={searchForm} layout="inline">
          ...
          <Form.Item name = "name" label="部位名称">
            <Input/>
          </Form.Item>
          <Form.Item>
      ...
      >
        <Form
          ...
          onFinish={onAddOk}
        >
          <Form.Item name = "name" label="部位名称" rules={[{required: true,},]}>
            <Input />
          </Form.Item>
        </Form>
      </Modal>
